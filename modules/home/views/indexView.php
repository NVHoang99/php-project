    ...
    <div class="wp-inner">
        <div class="main-content fl-right">
            ...
            <div class="section" id="list-product-wp">
                <div class="section-head">
                    <h3 class="section-title"><a
                            href="<?php echo '?mod=product&controller=index&action=index&id=1' ?>">Điện thoại</a></h3>
                </div>
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <?php
            ...
            <div class="section" id="list-product-wp">
                <div class="section-head">
                    <h3 class="section-title"><a
                            href="<?php echo '?mod=product&controller=index&action=index&id=2' ?>">Laptop</a></h3>
                </div>
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <?php
            ...
            <div class="section" id="list-product-wp">
                <div class="section-head">
                    <h3 class="section-title"><a
                            href="<?php echo '?mod=product&controller=index&action=index&id=3' ?>">Tai nghe</a></h3>
                </div>
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <?php
                        foreach ($list_headphone as $item) {
                        ?>
                        <li>
                            <a href="<?php echo '?mod=product&controller=index&action=detail&id=' . $item['_id'] ?>"
                                title="" class="thumb">
            ...
            <div class="section" id="list-product-wp">
                <div class="section-head">
                    <h3 class="section-title"><a
                            href="<?php echo '?mod=product&controller=index&action=index&id=4' ?>">Thời trang</a></h3>
                </div>
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <?php
                        foreach ($list_fashion as $item) {
                        ?>
                        <li>
                            <a href="<?php echo '?mod=product&controller=index&action=detail&id=' . $item['_id'] ?>"
                                title="" class="thumb">
            ...
            <div class="section" id="list-product-wp">
                <div class="section-head">
                    <h3 class="section-title"><a
                            href="<?php echo '?mod=product&controller=index&action=index&id=5' ?>">Đồ gia dụng</a></h3>
                </div>
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <?php
                        foreach ($list_houseware as $item) {
                        ?>
                        <li>
                            <a href="<?php echo '?mod=product&controller=index&action=detail&id=' . $item['_id'] ?>"
                                title="" class="thumb">
            ...
            <div class="section" id="list-product-wp">
                <div class="section-head">
                    <h3 class="section-title"><a
                            href="<?php echo '?mod=product&controller=index&action=index&id=6' ?>">Đồ văn phòng</a></h3>
                </div>
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <?php
                        foreach ($list_office as $item) {
                        ?>
                        <li>
                            <a href="<?php echo '?mod=product&controller=index&action=detail&id=' . $item['_id'] ?>"
                                title="" class="thumb">
